...
<form method="post">
	...
	<td>
				<select name="txtreli" class="form-control">
					<option>select</option>
					<?php
						$q=mysqli_query($con,"select distinct religion from regtable");
...
if(isset($_POST['btnsearch'])){
	extract($_POST);
$q=mysqli_query($con,"select * from regtable where religion = '".$txtreli."' and gender !='".$_SESSION['gender']."'");
}
else{
