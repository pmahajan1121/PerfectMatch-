...
<form method="post">
	<table class="table">
		<tr>
			<td>
				<h5><b>Search By Caste</b></h5>
			</td>
			
			<td>
				<select name="txtcaste" class="form-control">
					<option>select</option>
					<?php
						$q=mysqli_query($con,"select distinct caste from regtable");
			...
			<Td>
				...
				<input type="button" name="btnsearch" value="Search" class="btn btn-info btn-sm ">
...
if(isset($_POST['btnsearch'])){
	extract($_POST);
$q=mysqli_query($con,"select * from regtable where caste = '".$txtcaste."' and gender !='".$_SESSION['gender']."'");
}
else{
